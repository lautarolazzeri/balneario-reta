...
function Alojamientos() {
  return (
    <section className='alquileres' id="alojamientos">
      <GradientSection title='Cabañas en alquiler en Reta, Tres Arroyos' subtitle='Conoce las mejores opciones de alquiler para tu estadía en Reta' url='/alojamientos' />
