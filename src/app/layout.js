  ...
  return (
    <html lang="es">
      <head>
        ...
        <meta name="description" content="Descubre la página web de Balneario Reta, tu guía completa para conocer Reta. Explora alojamientos, atracciones turísticas, mucha información, eventos, festivales y muchas imágenes." />
