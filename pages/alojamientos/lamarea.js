  ...
  return (
    <>
      ...
      <div className="single-place">
        ...
        <h3>Cabañas la Marea</h3>
        <p className="direction-place">Calle 31 y 40 - Reta</p>
        <h6>Contamos con distintas cabañas con distintas caracteristicas de 2 a 5 personas.</h6>

        <a className="lamarea" href="https://www.complejolamarea.com/loft-la-marea-suites/">Loft La marea Suites (2p)</a>
        <p className="lamareatext">Tiene todas las comodidades pensadas para solo una pareja.
          Ubicada sobre calle 40 entre 31 y 29. Son dos unidades tipo loft único, cuenta con cocina con anafe, pava eléctrica y  microondas, tv, aire acondicionado, heladera con freezer, wi-fi, parrilla individual, estacionamiento cubierto, mesa con sillas de jardin.</p>
        ...
        <div className="contact-place">
          <h6>Sitio web: <a className="sitio" href="https://complejolamarea.com">Complejolamarea.com</a> </h6>
          <p><b>Teléfono:</b>2983-563857</p>
          <div className="buttons-alojamiento">
            <Link target="_blank" href='https://api.whatsapp.com/send?phone=5492983563857&text=Hola!%20Lo%20contacto%20para%20consultar%20por:%20https://www.balnearioretaoficial.com.ar/alojamientos/lamarea%0A%0AQuisiera%20saber:%20'>
            ...
            <Link target="_blank" href='tel:02983563857'>
            ...
            <Link target="_blank" href='mailto:lamarea_reta@yahoo.com.ar'>
