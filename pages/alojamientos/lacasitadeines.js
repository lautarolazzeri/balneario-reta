...
export default function Marsu() {
  ...
  const casitadeinesimages = [
    ...
    { url: "/alquileres/lacasitadeines/lacasitadeines2.jpg", width: 1300, height: 1000 },
    { url: "/alquileres/lacasitadeines/lacasitadeines3.jpg", width: 1300, height: 1000 },
    { url: "/alquileres/lacasitadeines/lacasitadeines4.jpg", width: 1300, height: 1000 },
  ]

  const casitadeinespic = casitadeinesimages.map((photo) => {
    ...
    return {
      ...
      width,
      height,
      alt: "Cabañas en reta - La casita de Ines",
  ...
  return (
    <>
      ...
      <div className="single-place">
        ...
        <h3>La casita rosada de Ines</h3>
        <p className="direction-place">Calle 54 esquina 29, a 2 cuadras de la playa</p>
        <h6>Cabaña para 4 personas</h6>
        <ul>
          <li>Cocina comedor</li>
          <li>Dormitorio con cama matrimonial</li>
          <li>Dormitorio con 2 camas de una plaza</li>
          <li>Baño completo</li>
          <li>Heladera con freezer</li>
          <li>Microondas</li>
          <li>Vajilla completa</li>
          <li>Cocina completa</li>
          <li>Termo tanque de recuperación rápida</li>
          <li>TV plasma con cable DirectTV</li>
          <li>Parrilla</li>
          <li>WI-FI</li>
          <li>Se permiten mascotas</li>
          <li>NO posee ropa de cama ni toallas</li>
        ...
        <div className="contact-place">
          ...
          <div className="buttons-alojamiento">
            <Link target="_blank" href='https://api.whatsapp.com/send?phone=541122361254&text=Hola!%20Lo%20contacto%20para%20consultar%20por:%20https://www.balnearioretaoficial.com.ar/alojamientos/lacasitadeines%0A%0AQuisiera%20saber:%20'>
            ...
            <Link target="_blank" href='tel:01122361254'>
        ...
        <PhotoAlbum layout="rows" photos={casitadeinespic} spacing={8} padding={0} targetRowHeight={400} />
