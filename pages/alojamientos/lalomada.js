...
export default function LaLomada() {

  const laLomadaimages = [
    { url: "/alquileres/lalomada/lalomada1.jpg", width: 800, height: 1000 },
    { url: "/alquileres/lalomada/lalomada2.jpg", width: 800, height: 1000 },
    { url: "/alquileres/lalomada/lalomada3.jpg", width: 800, height: 1000 },
    { url: "/alquileres/lalomada/lalomada4.jpg", width: 1300, height: 1000 },
    { url: "/alquileres/lalomada/lalomada5.jpg", width: 900, height: 1000 },
    { url: "/alquileres/lalomada/lalomada6.jpg", width: 1100, height: 1000 },
    { url: "/alquileres/lalomada/lalomada7.jpg", width: 1300, height: 1000 },
    { url: "/alquileres/lalomada/lalomada8.jpg", width: 1100, height: 1000 },
    { url: "/alquileres/lalomada/lalomada9.jpg", width: 1200, height: 1000 },
    { url: "/alquileres/lalomada/lalomada10.jpg", width: 1400, height: 1000 },
    { url: "/alquileres/lalomada/lalomada11.jpg", width: 1100, height: 1000 },
    { url: "/alquileres/lalomada/lalomada12.jpg", width: 1400, height: 1000 },
  ]

  const laLomadapic = laLomadaimages.map((photo) => {
  ...
  return (
    <>
      ...
      <div className="single-place">
        ...
        <h3>La Lomada</h3>
        <p className="direction-place">calle 25 entre 44 y 46</p>
        <h6>Casa para 6 personas.</h6>
        <h6>Ubicada a una cuadra del centro y a cuatro de la playa (balneario principal).</h6>

        <ul>
          <li>Patio arbolado.</li>
          <li>Galería amplia/cochera.</li>
          <li>Lavadero.</li>
          <li>Chulengo/parrilla.</li>
          <li>Vajilla completa.</li>
          <li>Heladera c/frizer.</li>
          <li>Microondas.</li>
          <li>Tostadora.</li>
          <li>WiFi fibra óptica.</li>
          <li>Aire acondicionado frio/calor.</li>
          <li>Se aceptan mascotas.</li>
          <li>No incluye ropa blanca.</li>
        </ul>
        ...
        <div className="contact-place">
          ...
          <div className="buttons-alojamiento">
            ...
            <Link target="_blank" href='tel:02983616856'>
        ...
        <PhotoAlbum layout="rows" photos={laLomadapic} spacing={8} padding={0} targetRowHeight={400} />
